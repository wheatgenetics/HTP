...
for uasPath in uasFolderList:
    ...
    if imageCount==0:
        ...
        print rangeDurations[rangeSegment]
...
#
    ...
    try:
        ...
        # Find the time index in GPS events that is less than or equal to the frame time
            ...
            #logTimeIndex = bisect.bisect_right(sortedKeys, timestamp)
            ...
            #print logTimeIndex,timestamp,abs(gpsEventsKey - timestamp),imagefilename
