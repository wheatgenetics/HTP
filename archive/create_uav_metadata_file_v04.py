...
def get_image_exif_data(ffilename):
    ...
    # Get Camera Image Date and Time
        ...
        print '*** Error Code:',e
        print '*** None EXIF-based column values will be generated for',ffilename
...
for f in imagefiles:
    ...
    with open(filename,'rb') as image:
        ...
        print cam_position_x, cam_position_y,cam_position_z, cam_longitude, cam_latitude,cam_altitude_ref
    image.close()
    #
