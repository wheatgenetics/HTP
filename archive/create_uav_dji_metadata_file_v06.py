...
#
# Version: 0.6 October 26,2016 Added timezonefinder library to determine timezone from lat/long position.
#
...
try:
    ...
    #
        ...
        logTimeIndex = bisect.bisect_right(sortedKeys, cam_time_in_seconds)
        #print logTimeIndex,cam_time_in_seconds,"{:15.4f}".format(sortedKeys[0]),sortedKeys[0]-cam_time_in_seconds
        ...
        #print "GPS Events Key:",gpsEventsKey
        ...
        referenceAltitude=317.1
        altRef=0 # Above Sea Level
        altMeters=uas_position_z+referenceAltitude
        #print "Latitude=",latDegrees,latMins,latSecs
        #print "Longitud=",lonDMS,lonMins,lonSecs
        #print "Altitude=",altMeters,uas_position_z
        try:
