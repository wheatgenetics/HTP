...
#
#
# Version: 0.3 - Possibly include images folder under the flight folder - To Be Decided
#
...
print ''
print 'Program: create_flight_directory.py Version: 0.2 '
...
if not os.path.exists(flightFolder):
    print 'Creating Flight Data Directory :',flightFolder
    print
