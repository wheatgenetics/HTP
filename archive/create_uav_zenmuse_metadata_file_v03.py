    ...
    with open(fflightLog, 'rU') as logfile:
        ...
        for row in log:
            ...
            if rowCount > 1: # skip the header line in the input file (i.e. the first row)
                ...
                nextAlt=altitude
                if takingVideo=='1':
                    gpsEventList=[lDate,lTime,latitude,longitude,altitude,takingVideo,interpolated,timeInSecs,utmPositionX,utmPositionY,utmLatZone,utmLongZone]
                ...
                if rowCount >2 and takingVideo=='1':
                    ...
                    if abs(timeDelta) > 10:
                        ...
                        while newTime < nextTime:
                            ...
                            #    gpsEventList=[rowFields[11],newLat,newLong,newAlt,takingVideo,interpolated,newTime]
                            #    gpsEventDict[newTime] = gpsEventList
                                #print '$',newTime,gpsEventDict[newTime]
                            #$newTime += 0.01
                            gpsEventList = [newDateStr,newTimeStr, newLat, newLong, newAlt, takingVideo, interpolated, newTime,newUtmPositionX,newUtmPositionY,newUtmLatZone,newUtmLongZone]
                            gpsEventDict[newTime] = gpsEventList
                            newTime += 10
                        ...
                        gpsEventList = [rowFields[11], newLat, newLong, newAlt, takingVideo, interpolated, newTime,newUtmPositionX,newUtmPositionY,newUtmLatZone,newUtmLongZone]
            prevTime=timeInSecs
            prevLat=latitude
            prevLong=longitude
            prevAlt=altitude
...
try:
    ...
    #
        ...
        print ''
        #print logTimeIndex-1,gpsEvents.keys()[logTimeIndex-1],logTimeIndex,gpsEvents.keys()[logTimeIndex],logTimeIndex+1,gpsEvents.keys()[logTimeIndex+1],cam_time_in_seconds,filename_jpg
