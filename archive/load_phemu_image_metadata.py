...
db_insert = "INSERT INTO phemu_images (image_file_name,run_id,camera_sn,absolute_sensor_position_x," \
...
with open(fname) as tsv:
    ...
    for line in csv.reader(tsv, delimiter="\t"):
        if lcount >= 1:
            ...
            data_insert = (imagefilename, runID, camerasn, absolutesensorpositionx, absolutesensorpositiony,
                           absolutesensorpositionz, samplingtimeutc, samplingdate, leftutc, leftelevation, leftlong,
                           leftlat,
                           longzone, latzone, leftutmx, leftutmy, rightutc, rightelevation, rightlong, rightlat,
                           rightutmx,
