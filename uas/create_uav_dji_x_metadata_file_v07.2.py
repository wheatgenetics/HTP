...
if renameImages == 'Y':
    #renamePath = os.mkdir(os.path.join(outPath, "renamed"))
    renamePath=os.path.join(outPath, "renamed")
    pathlib.Path(renamePath).mkdir(parents=False, exist_ok=True)
    ...
    #
        ...
        try:
            ...
            # Find the time index in GPS events that is less than or equal to the frame time
                ...
                uas_position_source = logSource # Position data derived from image EXIF
            ...
            # Rename image files if specified on command line input
                ...
                if renameImages == 'Y':
                    ...
                    newimagefilepath = renamePath + sensor_id + '_' + imgDate + '_' + imgTime + '_' + imagefilename
                ...
                try:
                    if updateExif=='Y':
                        ...
                        #      "Longitude Ref:", uas_longitude_ref)
